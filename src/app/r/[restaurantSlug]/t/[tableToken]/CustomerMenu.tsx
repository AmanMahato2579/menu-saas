...
import { ShoppingCart, BellRing, Loader2, AlertCircle, Receipt, ClipboardList, Phone, Copy, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
      ...
      <div className="max-w-lg mx-auto">
        ...
        {/* Quick links: My Orders + View Bill on top */}
        <div className="px-4 pt-4 grid grid-cols-2 gap-3 sticky top-[-4px] z-20">
          <Link
            href={`${baseUrl}/orders`}
